...
namespace JoltPhysics
{
    ...
    class EditorJoltMeshAssetColliderComponent
        : public EditorJoltColliderComponentBase
        , private AZ::Data::AssetBus::Handler
        , private AZ::Render::MeshComponentNotificationBus::Handler
    {
    public:
        AZ_COMPONENT(EditorJoltMeshAssetColliderComponent, "{F3B6A8D6-CE7C-4C21-B12F-9D9C09F7AECB}", EditorJoltColliderComponentBase);
