...
namespace JoltPhysics
{
    ...
    void EditorJoltMeshAssetColliderComponent::Reflect(AZ::ReflectContext* context)
    {
        ...
        if (auto* serializeContext = azrtti_cast<AZ::SerializeContext*>(context))
        {
            serializeContext->Class<EditorJoltMeshAssetColliderComponent, EditorJoltColliderComponentBase>()
                ->Version(1)
                ->Field("ShapeConfiguration", &EditorJoltMeshAssetColliderComponent::m_proxyShapeConfiguration)
                ->Field("ContentLabel", &EditorJoltMeshAssetColliderComponent::m_contentLabel)
                ;
            ...
            if (AZ::EditContext* editContext = serializeContext->GetEditContext())
            {
                editContext->Class<EditorJoltMeshAssetColliderComponent>(
                    ...
                    ->ClassElement(AZ::Edit::ClassElements::EditorData, "")
                        ...
                        ->Attribute(AZ::Edit::Attributes::AutoExpand, true)
                    ->DataElement(AZ::Edit::UIHandlers::Default, &EditorJoltMeshAssetColliderComponent::m_proxyShapeConfiguration,
                        "Shape Configuration", "The .joltmesh asset and its shape settings.")
                        ->Attribute(AZ::Edit::Attributes::Visibility, AZ::Edit::PropertyVisibility::ShowChildrenOnly)
                        ->Attribute(AZ::Edit::Attributes::ChangeNotify, &EditorJoltMeshAssetColliderComponent::OnShapeConfigurationChanged)
                    ->DataElement(AZ::Edit::UIHandlers::Default, &EditorJoltMeshAssetColliderComponent::m_contentLabel,
    ...
    void EditorJoltMeshAssetColliderComponent::Activate()
    {
    ...
    void EditorJoltMeshAssetColliderComponent::Deactivate()
    {
    ...
    void EditorJoltMeshAssetColliderComponent::UpdateMeshAsset()
    {
    ...
    void EditorJoltMeshAssetColliderComponent::OnAssetReady(AZ::Data::Asset<AZ::Data::AssetData> asset)
    {
    ...
    void EditorJoltMeshAssetColliderComponent::OnAssetReloaded(AZ::Data::Asset<AZ::Data::AssetData> asset)
    {
    ...
    void EditorJoltMeshAssetColliderComponent::UpdateMaterialSlotsFromMeshAsset()
    {
    ...
    void EditorJoltMeshAssetColliderComponent::UpdateContentLabel()
    {
        if (!m_proxyShapeConfiguration.m_asset.GetId().IsValid())
        {
    ...
    AZ::u32 EditorJoltMeshAssetColliderComponent::OnShapeConfigurationChanged()
    {
        UpdateMeshAsset();
        return AZ::Edit::PropertyRefreshLevels::AttributesAndValues;
    }

    bool EditorJoltMeshAssetColliderComponent::ShouldUpdateCollisionMeshFromRender() const
    {
    ...
    void EditorJoltMeshAssetColliderComponent::OnModelReady(
    ...
    void EditorJoltMeshAssetColliderComponent::SetCollisionMeshFromRender()
    {
    ...
    AZ::Data::AssetId EditorJoltMeshAssetColliderComponent::FindMatchingJoltMeshAsset(
    ...
    void EditorJoltMeshAssetColliderComponent::AssignMeshAsset(const AZ::Data::AssetId& assetId)
    {
    ...
    void EditorJoltMeshAssetColliderComponent::RebuildDebugLines() const
    {
        m_debugLines.clear();
    ...
    AZ::Aabb EditorJoltMeshAssetColliderComponent::GetLocalShapeBounds() const
    {
    ...
    AZ::Aabb EditorJoltMeshAssetColliderComponent::GetEditorSelectionBoundsViewport(
    ...
    void EditorJoltMeshAssetColliderComponent::DrawShape(AzFramework::DebugDisplayRequests& debugDisplay) const
    {
        if (m_debugLinesDirty)
        {
            RebuildDebugLines();
