...
namespace JoltPhysics
{
    ...
    //! EditorJoltMeshAssetColliderComponent) for the Jolt physics backend. The asset's
    ...
    //! for dynamic bodies.
    class JoltMeshAssetColliderComponent
        : public JoltColliderComponentBase
        , private AZ::Data::AssetBus::MultiHandler
    {
    public:
        AZ_COMPONENT(JoltMeshAssetColliderComponent, "{3A069B43-1B63-4ECD-A382-B5618C1D97C3}", JoltColliderComponentBase);
