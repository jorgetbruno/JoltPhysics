...
namespace JoltPhysics
{
    ...
    void JoltMeshAssetColliderComponent::Reflect(AZ::ReflectContext* context)
    {
        ...
        if (auto* serializeContext = azrtti_cast<AZ::SerializeContext*>(context))
        {
            ...
            serializeContext->Class<JoltMeshAssetColliderComponent, JoltColliderComponentBase>()
                ->Version(1)
                ->Field("ShapeConfiguration", &JoltMeshAssetColliderComponent::m_shapeConfig)
                ;
    ...
    void JoltMeshAssetColliderComponent::Activate()
    {
    ...
    void JoltMeshAssetColliderComponent::Deactivate()
    {
        AZ::Data::AssetBus::MultiHandler::BusDisconnect();
        JoltColliderComponentBase::Deactivate();
    }

    void JoltMeshAssetColliderComponent::OnAssetReady(AZ::Data::Asset<AZ::Data::AssetData> asset)
    {
    ...
    void JoltMeshAssetColliderComponent::OnAssetReloaded(AZ::Data::Asset<AZ::Data::AssetData> asset)
    {
        if (asset == m_shapeConfig->m_asset)
        {
            m_shapeConfig->m_asset = asset;
    ...
    void JoltMeshAssetColliderComponent::ApplyMaterialSlotsFromAsset()
    {
    ...
    AzPhysics::ShapeColliderPair JoltMeshAssetColliderComponent::GetShapeColliderPair() const
    {
        return { m_colliderConfiguration, m_shapeConfig };
    }

    AzPhysics::ShapeColliderPairList JoltMeshAssetColliderComponent::GetShapeColliderPairs() const
    {
