...
namespace JoltPhysics
{
    ...
    //! EditorJoltBakedMeshColliderComponent, which bakes the entity's render geometry).
    ...
    class JoltBakedMeshColliderComponent
        : public JoltColliderComponentBase
    {
    public:
        AZ_COMPONENT(JoltBakedMeshColliderComponent, "{E5F6A7B8-C9D0-4E1F-A2B3-C4D5E6F7A8B9}", JoltColliderComponentBase);
